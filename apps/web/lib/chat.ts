...
export const mockChats: Chat[] = [
	{
		...
		messages: [
			...
			},
			{
				...
				role: "assistant",
				content:
					"I'd be happy to review your auth middleware. Please share the code and I'll analyze it for security best practices.",
	...
	},
	{
		...
		messages: [
			...
			},
			{
				...
				role: "assistant",
				content:
					"Sure! Please share the query and table schema. I'll analyze the execution plan and suggest optimizations.",
	...
	},
	{
		...
		messages: [
			...
			},
			{
				...
				role: "assistant",
				content:
					"I'll create an engaging blog post about AI agents. What's your target audience and preferred tone?",
	...
	},
	{
		...
		messages: [
			...
			},
			{
				...
				role: "assistant",
				content:
					"I'll help you create the Kubernetes manifests. Let me generate a deployment, service, and ingress configuration.",
